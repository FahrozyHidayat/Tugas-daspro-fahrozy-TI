...
namespace TebakKata
{
    ...
    class Program
    {
        ...
        static void Intro()
        {
            WordGuess.Write("Selamat datang dalam permainan Tebak Kata.\n");
            WordGuess.Write("Pada Permainan ini, para player akan menebak kata rahasia.\n");
            WordGuess.Write($"Setiap player memiliki {kesempatan} kesempatan.\n");
            WordGuess.Write("Petunjuk untuk tebak kata adalah kata ini merupakan genre musik.\n");
            WordGuess.Write($"Kata Rahasia ini terdiri dari {kataRahasia.Length} huruf.\n");
            WordGuess.Write("Selamat bermain!\n");
            Console.ReadKey();
        }
